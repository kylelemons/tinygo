...
func fillFont(block *[32 * 16]machine.Tile4, offset *int, font *tinyfont.Font, color int) (start int) {
...
func main() {
	...
	fontStart := fillFont(&machine.Tile.Blocks4[machine.TILE_BLOCK_S1], &nextTile, font, fontColor)
